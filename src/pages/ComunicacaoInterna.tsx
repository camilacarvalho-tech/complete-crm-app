          ...
          <div className="p-4 bg-slate-800 border-b border-slate-700 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="text-xs px-3 py-1.5 bg-code-action hover:brightness-110 text-white rounded-lg flex items-center gap-2 font-semibold"
              >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormCliente({...formCliente, cpf: maskCpf(e.target.value)})}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormCliente({...formCliente, telefone: maskPhone(e.target.value)})}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormCliente({...formCliente, whatsapp: maskPhone(e.target.value)})}
                        placeholder="(00) 00000-0000"
                        className="w-full px-3 py-2 text-sm rounded-lg bg-slate-700 text-white placeholder-slate-400"
                      />
                    </div>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-slate-400">
              Cria a conversa e abre a ficha do cliente à direita.
            </p>
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-lg bg-code-action hover:brightness-110 text-white font-semibold"
              >
                Criar e abrir ficha
              </button>
            </div>
